...
export class HomeComponent implements OnInit{  
  ...
  bestSeller: BestSeller[] = [
    {image: '/img26.png', name:'The north coat',info:'Premium insulated coat designed for ultimate warmth and comfort. Made with high-quality, weather-resistant materials to protect against the elements. Lightweight yet durable, perfect for outdoor adventures or everyday wear.' ,price: '260', originalPrice:'$360', ratings: 4, reviews: 100, inStock:true ,  isFavorite: false},
    {image: '/img27.png', name:'Gucci duffle bag',info:'Luxury travel bag crafted from high-quality materials with iconic Gucci design. Spacious interior with multiple compartments for organized storage. Durable handles and an adjustable shoulder strap for', price: '960', originalPrice:'$1160', ratings: 3, reviews: 100, inStock:true , isFavorite : false},
    {image: '/img28.png', name:'RGB liquid CPU Cooler',info:'High-performance cooling with vibrant RGB lighting. Premium build with a durable pump and silent fans for efficient heat dissipation. Easy installation with universal socket compatibility.', price: '160', originalPrice:'$170', ratings: 4, reviews: 100, inStock:false , isFavorite : false},
    {image: '/img29.png', name:'Small BookSelf',info:'Compact and sturdy design, perfect for organizing books, décor, and essentials. Made from high-quality materials for durability and stability. Space-saving solution for home, office, or study rooms. Easy to assemble and stylishly fits any décor.', price: '360',originalPrice:'', ratings: 2, reviews: 100, inStock:true , isFavorite : false},
    {image: '/img30.png', name:'Breed Dry Dog Food',info:'Nutrient-rich formula tailored for optimal health and energy. Made with high-quality ingredients to support digestion, coat health, and strong muscles. No artificial flavors or preservatives. Perfect for daily feeding and balanced nutrition.', price: '360',originalPrice:'', ratings: 2, reviews: 100, inStock:false , isFavorite : false},
    {image: '/img31.png', name:'CANON EOS DSLR Camera',info:'High-performance DSLR with advanced imaging technology for stunning photos and videos. Features a powerful sensor, fast autofocus, and versatile lens compatibility. User-friendly controls with built-in Wi-Fi and HD video recording. Perfect for professionals and beginners alike.', price: '360',originalPrice:'', ratings: 2, reviews: 100, inStock:true , isFavorite : false},
    {image: '/img32.png', name:'ASUS FHD Gaming Laptop',info:'Powerful gaming laptop with a high-refresh-rate Full HD display for smooth visuals. Equipped with a high-performance processor and dedicated GPU for seamless gameplay. Advanced cooling system and RGB-backlit keyboard for an immersive gaming experience. Perfect for gamers and content creators.', price: '360',originalPrice:'', ratings: 2, reviews: 100, inStock: false , isFavorite : false},
    {image: '/img33.png', name:'Curology Product Set ',info:'Customized skincare regimen tailored to your skin’s unique needs. Includes a personalized formula, cleanser, and moisturizer for a complete skincare routine. Dermatologist-designed with high-quality ingredients to target acne, wrinkles, and dark spots. Gentle, effective, and perfect for all skin types.', price: '60',originalPrice:'', ratings: 2, reviews: 100, inStock:true , isFavorite : false},
    ...
    {image: '/img39.png', name:'Havic HV G-92 Gamepad',info:'PlayStation 5 Controller Skin High quality vinyl with air channel adhesive for easy bubble-free install & mess-free removal. Pressure sensitive.',price:'360',originalPrice:'', ratings: 2,reviews: 100, inStock:true , isFavorite : false}
  ]
